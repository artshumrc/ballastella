...
A historical map added from a remote IIIF URI is referenced in place: its tiles stay on the host. A per-image action — "make an offline copy" — fetches it into the workspace instead. Local images have their tiles here by definition.
