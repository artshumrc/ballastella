...
//
// The count is whatever `playwright test --list` reports, skips included — 669 today, one of which
...
//
//     BALLASTELLA_SEAM_2_CEILING=668 node scripts/check-seam-2-size.mjs   # must fail
 ...
 */
export const SEAM_2_CEILING = 669;
