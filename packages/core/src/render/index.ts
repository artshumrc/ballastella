...
// Whether the frame on screen can be captured, as a reducer over the events that change the answer.
// The pane feeds it map events and the page feeds it asset outcomes; neither owns the rules.
export {
	FRAME_INVALIDATORS,
	canCaptureSnapshot,
