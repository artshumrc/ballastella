...
// `alignments/<id>.json` hoisted); a Workspace and a published tree spell the Project's own files
...
// Project offered as a bundle, as a published tree, and as a Review Workspace reports the *same* path
...
// what an author published. An Import copies work into a Workspace the user owns, and ADR-0037
 ...
 * publishing's, regenerated by the next Publish, not the author's scholarship (ADR-0006).
 *
 ...
 * because a reviewer looking at somebody's published mistake is better served by the Annotations that
 ...
 * reserved temporary suffix — and two spellings of it is how a bundle and a published tree come to
